...
| RF-E10-02 | Sistema oferece planos com limites: profissionais/agendas, storage de anexos (sem franquia Meta de mensagem no default WAHA) | Must | US-10.2 |
...
| RF-E10-08 | Owner visualiza plano atual, uso (profissionais, storage) e histórico de status | Must | US-10.2 |
...
| RF-E10-11 | Créditos de mensagem Meta: **não** no default WAHA ([ADR-0016](../../adr/0016-waha-default-messaging.md)). Se o comercial do plano ainda citar créditos, decidir na implementação | Could | ADR-0016 |
