...
CREATE TABLE patient (
  ...
  code             bigint GENERATED BY DEFAULT AS IDENTITY, -- nº de ficha exibido ao usuário
  name             text NOT NULL,
  social_name      text,
  cpf              char(11),
  birth_date       date,
...
CREATE TABLE treatment_item (
  ...
  status            text NOT NULL DEFAULT 'PLANNED', -- PLANNED|IN_PROGRESS|EXECUTED|CANCELLED
